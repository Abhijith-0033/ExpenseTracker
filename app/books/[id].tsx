...
const styles = StyleSheet.create({
    ...
    heroLabel: { color: 'rgba(255,255,255,0.8)', fontSize: 14, marginBottom: 8, fontWeight: '600' },
    heroAmount: { color: 'white', fontSize: 36, fontWeight: '800', marginBottom: 16 },
    ...
    budgetText: { color: 'white', fontSize: 12, fontWeight: '600' },
    progressTrack: { height: 6, backgroundColor: 'rgba(255,255,255,0.2)', borderRadius: 3, overflow: 'hidden' },
    progressBar: { height: '100%', borderRadius: 3 },
    overBudgetWarning: { color: '#fee2e2', fontSize: 12, marginTop: 8, fontWeight: 'bold' },
    ...
    itemName: { fontSize: 16, fontWeight: '600', color: Colors.gray[900], marginBottom: 4 },
    itemNotes: { fontSize: 13, color: Colors.gray[500], marginBottom: 8 },
    dateRow: { flexDirection: 'row', alignItems: 'center', gap: 4 },
    itemDate: { fontSize: 12, color: Colors.gray[400] },
    itemRight: { alignItems: 'flex-end', gap: 8 },
    itemAmount: { fontSize: 16, fontWeight: '700', color: Colors.gray[900] },
    deleteBtn: { padding: 4 },
    ...
    input: { backgroundColor: Colors.gray[100], padding: 16, borderRadius: 12, marginBottom: 20, fontSize: 16 },
    ...
    incomeBadgeText: { color: Colors.success[600], fontSize: 10, fontWeight: '700', textTransform: 'uppercase' },
    ...
    typeBtnText: { fontSize: 14, fontWeight: '600', color: Colors.gray[500] },
    ...
    sourcePillText: { fontSize: 13, color: Colors.gray[600] },
    sourcePillTextActive: { color: Colors.success[700], fontWeight: '600' },
